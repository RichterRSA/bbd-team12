              ...
              {availableGames.map((game) => (
                ...
                >
                  ...
                  <div className="flex space-x-4 w-full">
                    ...
                    disabled={connectionStatus !== 'connected'}
                    className="flex-1 flex justify-center items-center px-4 py-3 bg-gradient-to-r from-indigo-600 to-purple-600 text-white rounded-md hover:from-indigo-500 hover:to-purple-500 disabled:opacity-50 transition-all duration-200"
                  >
                    <UserPlus size={18} className="mr-2" /> Join Match
                  </button>
                  <button 
                    onClick={() => window.location.href = `/spectator`} // add game id:  ${game.id}
                    className="flex-1 flex justify-center items-center px-4 py-3 bg-gradient-to-r from-gray-600 to-gray-800 text-white rounded-md hover:from-gray-500 hover:to-gray-700 transition-all duration-200"
